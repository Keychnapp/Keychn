...
//  Keychn
//
//  Created by Rohit Kumar on 10/01/2018.
...
@IBDesignable public class TriLabelView: UIView {
    ...
    @IBInspectable public var lengthPercentage:CGFloat = 90.0 {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    @IBInspectable public var labelFont: UIFont = UIFont.setRobotoFontBoldStyleWithSize(13) {
        didSet {
            setNeedsDisplay()
        }
    }
...
//        firstLabel.changeFont(labelFont: labelFont)
        ...
        firstLabel.font     = UIFont .setRobotoFontBoldStyleWithSize(14);
