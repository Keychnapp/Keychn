...
NSString  *aboutUsURL                  = @"http://www.keychn.com/#!/terms";
NSString  *privacyPolicyURL            = @"http://www.keychn.com/#!/privacy";
NSString  *termsOfUsePolicy            = @"http://www.keychn.com/#!/terms";
...
NSString  *bookAMasterClassSpotAction  = @"userapis/bookMasterClassNew";
...
NSString  *kIsListner                = @"is_listener";
...
NSString  *kBannerImageURL           = @"banner_url";
